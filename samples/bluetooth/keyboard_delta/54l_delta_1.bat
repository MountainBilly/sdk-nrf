...
west build -p -b nrf54l15dk/nrf54l15/cpuapp -d build_54l -- -DCONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=\"1.0.1+1\"
@REM @REM Backup original hex file
copy build_54l\merged.hex delta_1011.hex
@REM Program the application to the board
west flash -d build_54l
...
arm-zephyr-eabi-objcopy --input-target=ihex --output-target=binary --gap-fill=0xff build_54l\keyboard_delta\zephyr\zephyr.signed.hex binaries\signed_images\source_1011.bin
