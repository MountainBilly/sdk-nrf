...
west build -p -b nrf54l15dk/nrf54l10/cpuapp -d build_54l10 -- -DCONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=\"1.0.1+1\"
@REM @REM Backup original hex file
copy build_54l10\merged.hex delta_1011.hex
@REM Program the application to the board
west flash -d build_54l10
...
set "dir=%ZEPHYR_BASE%\nrf\samples\bluetooth\keyboard_delta\binaries\signed_images"
...
arm-zephyr-eabi-objcopy --input-target=ihex --output-target=binary --gap-fill=0xff build_54l10\keyboard_delta\zephyr\zephyr.signed.hex binaries\signed_images\source_1011.bin
