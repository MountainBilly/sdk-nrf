...
def sign_patch_file_by_config(build_dir):
    ...
    image_version = awklike('CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=',
                            build_dir + '/keyboard_delta/zephyr/.config')
...
def generate_dfu_zip(build_dir):
    ...
    board = awklike('CONFIG_BOARD=', build_dir + '/keyboard_delta/zephyr/.config')
    soc = awklike('CONFIG_SOC=', build_dir + '/keyboard_delta/zephyr/.config')
