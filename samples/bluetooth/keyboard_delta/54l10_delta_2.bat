...
west build -p -b nrf54l15dk/nrf54l10/cpuapp -d build_54l10_2 -- -DFILE_SUFFIX=delta -DCONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION=\"2.0.2+2\"
@REM Backup original hex file
copy build_54l10_2\merged.hex delta_2022.hex
...
arm-zephyr-eabi-objcopy --input-target=ihex --output-target=binary --gap-fill=0xff build_54l10_2\keyboard_delta\zephyr\zephyr.signed.hex binaries\signed_images\target_2022.bin
...
python scripts\patch_with_arg.py -d build_54l10_2
